                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <?php while ($row = $stmt->fetch(PDO::FETCH_ASSOC)): ?>
                    <tr>
                      ...
                      <td><?php echo htmlspecialchars($row['nama_stakeholder']); ?></td>
                      <td>
                          <button class = "btn btn-success" onclick="togglePopup('<?php echo $row['id_pengguna']; ?>','<?php echo $row['id_biodata']; ?>', '<?php echo $row['id_stakeholder']; ?>')">Edit</button>
