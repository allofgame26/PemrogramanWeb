            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <?php
                  ...
                  require_once "../../../crudmahasiswa.php";
                  ...
                  if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    if (isset($_POST['create'])) {
                        ...
                        $user->id_mahasiswa = $_POST['id_mahasiswa'];
                        $user->id_pengguna = $_POST['id_pengguna'];
                        $user->nim = $_POST['nim'];
                        $user->jurusan = $_POST['jurusan'];
                        $user->prodi = $_POST['prodi'];
                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <?php while ($row = $stmt->fetch(PDO::FETCH_ASSOC)): ?>
                    <tr>
                      <td><?php echo htmlspecialchars($row['id_mahasiswa']); ?></td>
                      ...
                      <td>
                          <button class = "btn btn-success" onclick="togglePopup('<?php echo $row['id_mahasiswa']; ?>','<?php echo $row['id_pengguna']; ?>', '<?php echo $row['nim']; ?>', '<?php echo $row['jurusan']; ?>','<?php echo $row['prodi']; ?>', '<?php echo $row['tahun_masuk']; ?>'">Edit</button>
...
<div id="popupOverlay" class="overlay-container"> 
                  ...
                  <script>
                    function togglePopup(id_mahasiswa = '',id_pengguna = '',nim = '' ,jurusan = '', prodi = '', tahun_masuk = '') {
                        const overlay = document.getElementById('popupOverlay');
                        overlay.classList.toggle('show');
