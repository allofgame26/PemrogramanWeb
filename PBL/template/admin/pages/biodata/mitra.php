        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="mitra.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Mitra Industri</p>
                </a>
              </li>
              ...
              <div class="card-body">
                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <?php while ($row = $stmt->fetch(PDO::FETCH_ASSOC)): ?>
                    <tr>
                      <td><?php echo htmlspecialchars($row['id_mitra']); ?></td>
                      ...
                      <td>
                          <button class = "btn btn-success" onclick="togglePopup('<?php echo $row['id_mitra']; ?>','<?php echo $row['id_pengguna']; ?>', '<?php echo $row['nama_perusahaan']; ?>', '<?php echo $row['kota']; ?>')">Edit</button>
...
<div id="popupOverlay" class="overlay-container"> 
                      ...
                      <span class="close" onclick="togglePopup()">&times;</span>
                            ...
                            <form method="post" class="form-container"  action="" id="userForm">
                              ...
                              <label class="form-label" for="id_pengguna">ID Pengguna:</label>
                                ...
                                <input class="form-input" type="text" placeholder="Masukkan Nama Perusahaan" name="nama_perusahaan" id="nama_perusahaan" required>
                                <label class="form-label" for="kota">Kota:</label>
                                <input class="form-input" type="text" placeholder="Masukkan kota" name="kota" id="kota" required>
                                <br>
                  ...
                  <script>
                    function togglePopup(id_mitra = '',id_pengguna = '',nama_perusahaan = '',kota = '') {
                        const overlay = document.getElementById('popupOverlay');
                        overlay.classList.toggle('show');

                        if (id_mitra) {
                            document.getElementById('popupTitle').innerText = 'Edit User';
                            document.getElementById('id_mitra').value = id_mitra;
                            document.getElementById('id_pengguna').value = id_pengguna;
                            document.getElementById('nama_perusahaan').value = nama_perusahaan;
