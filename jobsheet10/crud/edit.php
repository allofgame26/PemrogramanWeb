...
<html>
    ...
    <body>
        ...
        $id = $_GET['id'];
        $query = "SELECT * FROM anggota WHERE id = $id"; //Query untuk memilih seluruh tabel anggota dari database
       ...
       <div class="container mt-4">
            ...
            <form action="proses.php?aksi=ubah" method="post"> <!--Pembuatan Form dengan aksi ke "proses.php?aksi=ubah" dengan metode post-->
