...
if (!empty($_SESSION['username'])) {
    ...
    if (!empty($_GET['jabatan'])) {
        ...
        $query = "UPDATE jabatan SET jabatan = '$jabatan', keterangan = '$keterangan' WHERE id_jabatan = '$id'";
        ...
        $query_anggota = "UPDATE anggota SET nama = '$nama', jenis_kelamin = '$jenis_kelamin', alamat = '$alamat', no_telp = '$no_telp', id_jabatan = '$jabatan' WHERE id_pengguna = '$user_id'";
        if (mysqli_query($koneksi, $query_anggota)) {
            if (!empty($_POST['password'])) {
                ...
                $query_user = "UPDATE pengguna SET username = '$username', password = '$hashed_password', salt = '$salt' WHERE id_pengguna = '$user_id'";
                ...
                $query_user = "UPDATE pengguna SET username = '$username' WHERE id_pengguna = '$user_id'";
                if (mysqli_query($koneksi, $query_user)) {
                    pesan('success', "Anggota Telah Diubah.");
                } else {
