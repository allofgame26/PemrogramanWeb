...
buat file baru dengan nama index.php dan mengetikkan kode -->
        ...
        <table class="table">
            ...
            <tbody>
                ...
                foreach ($tampil as $show) {
                        echo "<tr>";
                        echo "<td>" . $show['id_jabatan'] . "</td>";
                        echo "<td>" . $show['jabatan'] . "</td>";
                        echo "<td>" . $show['keterangan'] . "</td>";
                        echo "<td>";
                        echo "<a href='edit.php?id=" . $show['id_jabatan'] . "' class='btn btn-primary btn-sm'>Edit</a> " ;
                        echo "<a href='index.php?action=delete&id=" . $show['id_jabatan'] . "' class='btn btn-danger btn-sm'>Delete</a>" ;
                        echo "</td>" ;
                        echo "</tr>" ;
                 }
                 ?>
